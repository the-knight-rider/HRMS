...
const MyTeam = () => {
  ...
  return (
    <div className="p-8 ml-12">
      <div>
        <h1 className="text-dark-blue text-[24px] font-bold text-center">My Teams</h1>
        <p className="text-primary-blue"><Link href={'/'} >Dashboard</Link> / Teams</p>
      </div>
      <div className="">
        <div className=" w-[100%] mt-8 grid grid-cols-8 md:grid-cols-8  gap-y-6 items-center justify-center  ">
          {team.map((emp) => (
            <div
