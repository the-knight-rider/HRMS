  ...
  return (
    <div className="p-4 flex flex-col gap-4">
      ...
      <div className=" bg-[#daf2ff]  rounded-tl-xl rounded-tr-xl px-4 py-2">
        ...
        <JourneyChart status="Submitted" date="May 06,2024" time="16:00:00" name="Aditya Shimpi  "/>
        <JourneyChart status="Rejected" date="May 06,2024" time="11:00:00" name="Bheem Singh"/>
        <JourneyChart status="Submitted" date="May 06,2024" time="10:00:00" name="Aditya Shimpi  "/>
        </div>
